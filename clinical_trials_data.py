...
def get_clinical_trials(drug_name):
    ...
    params = {
        ...
        "filter.overallStatus": "COMPLETED",  # Filter for completed trials this will focus on phase and phase 4 trials as mentioned in the documents
...
def pull_data_for_drugs(drugs):
    ...
    for drug in drugs:
        ...
        # introducing a  delay to avoid hitting API rate limits
        time.sleep(2)
